...
public class TranslationHelper {
    ...
    static {
        bid2ModName.put(48, "RedPower");
        bid2ModName.put(85, "Railcraft");
        bid2ModName.put(98, "RedPower");
        ...
        bid2ModName.put(181, "IronChests");
        bid2ModName.put(183, "IronChests");
        bid2ModName.put(187, "Industrial Craft 2");
        bid2ModName.put(188, "Industrial Craft 2");
        bid2ModName.put(190, "Nether Ores");
        bid2ModName.put(192, "Industrial Craft 2");
        bid2ModName.put(194, "immibis.tubestuff.BlockTubestuff");
        bid2ModName.put(206, "Railcraft");
        bid2ModName.put(207, "dan200.computer.shared.BlockComputer");
        bid2ModName.put(208, "dan200.computer.shared.BlockPeripheral");
